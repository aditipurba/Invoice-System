...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <br />
      <div align="right">
        <a href="cr_bl.php?add=1" class="btn btn-info btn-xs">Create</a>
      </div>
     <br>
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="index2.php?csv=1&id='.$row["order_id"].'">CSV</a></td>
                <td><a href="cr_bl.php?update=1&id='.$row["order_id"].'"><button type="button" class="btn btn-primary btn-sm">Edit</button></a></td>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete', function(){
      ...
      {
        window.location.href="cr_bl.php?delete=1&id="+id;
      }
      else
      {
        return false;
