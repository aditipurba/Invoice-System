...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      ?>
      <br><br>
      <h2 align="center"><b>Billing and Approval System<b></h2>

      <br />
      <div align="center">
        <a href="create_bill.php?add=1" class="btn btn-info">Create</a>
      </div>
     <br>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete', function(){
      ...
      {
        window.location.href="create_bill.php?delete=1&id="+id;
      }
      else
      {
        return false;
