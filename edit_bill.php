...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <br />
      <div align="right">
        <a href="edit_bill.php?add=1" class="btn btn-info btn-xs">Create</a>
      </div>
     <br>
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="edit_bill.php?update=1&id='.$row["order_id"].'"><button type="button" class="btn btn-primary btn-sm">Edit</button></a></td>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete', function(){
      ...
      {
        window.location.href="edit_bill.php?delete=1&id="+id;
      }
      else
      {
        return false;
